...
path_3_3_3_list = ["Cards are great way to chat and have fun at the same time you thought. Your friend slowly reaches behind her and pulls out a deck of worn out Tarot cards. She first reveals these cards were handed down to from generations past. We sit down on the carpet by the fireplace and she deals out my cards. She has you methodically turn over each card - explaining the meaning of each like she was reading her very own horoscope. On the last card she explains this one has a special meaning and should not be taken lightly. The card she turns over is either the PROSPER card, or the DEATH card.", "prosper", "death",
                   f"The Prosper Card, yes! Your friend was so happy for you. And you know what {fname}, she was on to something. The universe had chose you to be very prosperous. Stinking rich. After you came home from your cabin retreat, you created a pill that cures cancer overnight. You eventually married a celebrity. You owned most of Florida and even a {monster}. You had it all - so it seemed. As your wealth grew, so did the ambitions and greed of your own family. They contracted a mobster to show you how to sleep with the fishes. Forget about it. You die.", f"As you flipped over the death card, your friend gasped. This could mean the end of life, she explained. However, it also can be the transition of life. Out with the old ways and in with the new. She explained most fear this card, they fear change. But her family has taught this can be the most powerful card in the deck. You have great things in store for you {fname}. She hugs you and we stay up chatting about life, future goals, even about {monster}s into the wee hours. You are surprised how much we have in common. The next couple of days brought you both even closer as friends. With each cabin sunrise the dark woods seemed less scary and more magical. You both left arm in arm refreshed after creating lasting memories. You found the Happy Ending!"]


# Choice Function
def choice_loop(list_path_1, list_path_2, choice_path, path_function_1, path_function_2):
    while True:
        choice_path = input(
            f">> Make a choice -> {list_path_1.upper()} or {list_path_2.upper()}? ").lower()

        # Escape Options
        if choice_path == "exit":
            print()
            break
        elif choice_path == "reset":
            os.system("cls")
            path()
            break

        # Endings - No Choice
        elif choice_path == "kick" and list_path_1 == path_1_list[1]:
            print()
            text_wrap(path_1_list[3])
            print()
            break
        elif choice_path == "wait" and list_path_1 == path_1_1_list[1]:
            print()
            text_wrap(path_1_1_list[3])
            print()
            break
        elif choice_path == "werewolf" and list_path_1 == path_1_1_1_list[1]:
            print()
            text_wrap(path_1_1_1_list[3])
            print()
            break
        elif choice_path == "calm" and list_path_1 == path_1_1_1_list[1]:
            print()
            text_wrap(path_1_1_1_list[4])
            print()
            break
        elif choice_path == "hug" and list_path_1 == path_2_2_2_list[1]:
            print()
            text_wrap(path_2_2_2_list[3])
            print()
            break
        elif choice_path == "scold" and list_path_1 == path_2_2_2_list[1]:
            print()
            text_wrap(path_2_2_2_list[4])
            print()
            break
        elif choice_path == "eat" and list_path_1 == path_3_list[1]:
            print()
            text_wrap(path_3_list[3])
            print()
            break
        elif choice_path == "run" and list_path_1 == path_3_list[1]:
            print()
            text_wrap(path_3_list[4])
            print()
            break
        elif choice_path == "movie" and list_path_1 == path_3_3_list[1]:
            print()
            text_wrap(path_3_3_list[3])
            print()
            break
        elif choice_path == "prosper" and list_path_1 == path_3_3_3_list[1]:
            print()
            text_wrap(path_3_3_3_list[3])
            print()
            break
        elif choice_path == "death" and list_path_1 == path_3_3_3_list[1]:
            print()
            text_wrap(path_3_3_3_list[4])
            print()
            break

        # Choice Functions
        elif choice_path == list_path_1:
            path_function_1()
            break
        elif choice_path == list_path_2:
            path_function_2()
            break

        # Try Again
        elif choice_path != list_path_1 or choice_path != list_path_2:
...
def path():
    ...
    path_choice = ""
    choice_loop(path_list[1], path_list[2],
                path_choice, path_1, path_2)
...
def path_1():
    ...
    path_1_choice = ""
    choice_loop(path_1_list[1], path_1_list[2],
                path_1_choice, path_1_1, blank)
...
def path_1_1():
    ...
    path_1_1_choice = ""
    choice_loop(path_1_1_list[1], path_1_1_list[2],
                path_1_1_choice, path_1_1_1, blank)
...
def path_1_1_1():
    ...
    path_1_1_1_choice = ""
    choice_loop(path_1_1_1_list[1], path_1_1_1_list[2],
                path_1_1_1_choice, blank, blank)
...
def path_2():
    ...
    path_2_choice = ""
    choice_loop(path_2_list[1], path_2_list[2],
                path_2_choice, path_2_2, path_3)
...
def path_2_2():
    ...
    path_2_2_choice = ""
    choice_loop(path_2_2_list[1], path_2_2_list[2],
                path_2_2_choice, path_2_2_2, path_3_3)
...
def path_2_2_2():
    ...
    path_2_2_2_choice = ""
    choice_loop(path_2_2_2_list[1], path_2_2_2_list[2],
                path_2_2_2_choice, blank, blank)
...
def path_3():
    ...
    path_3_choice = ""
    choice_loop(path_3_list[1], path_3_list[2],
                path_3_choice, blank, blank)
...
def path_3_3():
    ...
    path_3_3_choice = ""
    choice_loop(path_3_3_list[1], path_3_3_list[2],
                path_3_3_choice, path_3_3_3, blank)
...
def path_3_3_3():
    ...
    path_3_3_3_choice = ""
    choice_loop(path_3_3_3_list[1], path_3_3_3_list[2],
                path_3_3_3_choice, blank, blank)
