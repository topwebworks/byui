...
def main():
    ...
    print(
        f"{total_molar_mass:.5f} grams/moles")

    # Print the number of moles.
    print(
        f"{moles:.5f} moles")

    chemical_name = get_formula_name(chemical_formula, known_molecules_dict)

    # Stretch - Print the formula name.
...
# Stretch - Make the formula dictionary.
...
def get_formula_name(formula, known_molecules_dict):
    ...
    if formula in known_molecules_dict:
        chemical_name = known_molecules_dict[formula].title()
    else:
        chemical_name = "unknown compound"
